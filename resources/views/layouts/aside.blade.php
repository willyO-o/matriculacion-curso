<aside class="sidenav navbar navbar-vertical z-index-3 navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand px-4 py-3 m-0" href="{{ url('/')}}">
            ...
            <span class="ms-1 text-sm text-dark">
                {{ config('app.APP_DATA.NOMBRE_EMPRESA') }}
            </span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{route('estudiante.index')}}">
                    <i class="material-symbols-rounded opacity-5">table_view</i>
                    <span class="nav-link-text ms-1">Estudiante</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" href="{{route('curso.index')}}">
                    <i class="material-symbols-rounded opacity-5">table_view</i>
                    <span class="nav-link-text ms-1">Curso</span>
                </a>
            </li>
